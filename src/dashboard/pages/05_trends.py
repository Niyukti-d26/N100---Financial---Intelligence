...
company_row = companies[companies["company_name"] == selected_company]
...
fig = px.line(pl, x="year", y="sales", markers=True, title="Revenue")

st.plotly_chart(fig, use_container_width=True)

st.subheader("Net Profit Trend")

fig = px.line(pl, x="year", y="net_profit", markers=True, title="Net Profit")

st.plotly_chart(fig, use_container_width=True)

st.subheader("EPS Trend")

fig = px.bar(pl, x="year", y="eps", title="Earnings Per Share")
...
fig = px.line(
    pl, x="year", y="operating_profit", markers=True, title="Operating Profit"
)
...
if not cf.empty:
    ...
    fig = px.bar(cf, x="year", y="net_cash_flow", title="Net Cash Flow")
    ...
    fig = px.line(
        cf,
        x="year",
        y=["operating_activity", "investing_activity", "financing_activity"],
        markers=True,
